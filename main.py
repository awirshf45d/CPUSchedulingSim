...
# ## Jobs (needs main_memory_size_kb)
# job_inputs: List[JobInput] = [
#     # Jobs -> Arrival time to Job Pool -> LTS -> Processes[new] -> Ready queue(s)[ready] -> STS -> CPU[running]
#     JobInput(at=0, cbt=10, memory_needed_kb=128, category="batch"),
#     JobInput(at=2, cbt=5, memory_needed_kb=256, category="interactive"),
#     JobInput(at=6, cbt=4, memory_needed_kb=64, category="real_time"),
# ]
